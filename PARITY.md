...
- [ ] **GAP-109a** Meshtastic write-to-device — wire the `.proto` set into Gradle, implement `AdminMessage` round-trips, then expose write-back from `MeshDeviceSettingsScreen`. Unblocks the "coming soon" banner shipped with GAP-109.
